...
export const STAGE_COLORS: Record<AppointmentStage, string> = {
  ...
  [AppointmentStage.TRANSFERRED]: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300 border-orange-200 dark:border-orange-800',
  [AppointmentStage.ACTIVATED]: 'bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300 border-sky-200 dark:border-sky-800',
};

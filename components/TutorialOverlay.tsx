...
import { IconArrowRight, IconBot, IconCycle, IconDollarSign, IconLayout, IconSparkles, IconDownload, IconTrendingUp, IconTransfer, IconLogo, IconClock } from './Icons';
...
export const TutorialOverlay: React.FC<TutorialOverlayProps> = ({ isOpen, userRole, onComplete }) => {
  ...
  const slides = userRole === 'admin' ? [
    { title: "Welcome to the Family!", description: "We're thrilled to have you lead the charge at Community Tax. This portal gives you full visibility into your team's performance and payroll.", icon: <IconLogo className="w-16 h-16 text-indigo-500" />, color: "bg-indigo-50 dark:bg-indigo-900/20" },
    { title: "Master Command Center", description: "The admin dashboard is designed to align your call center agents with high-performing Account Executives.", icon: <IconSparkles className="w-16 h-16 text-rose-500" />, color: "bg-rose-50 dark:bg-rose-900/20" },
    ...
    { title: "Welcome to the Family!", description: "We're excited to have you on board! This app is your companion to track client journeys, maximize earnings, and crush your goals.", icon: <IconLogo className="w-16 h-16 text-indigo-500" />, color: "bg-indigo-50 dark:bg-indigo-900/20" },
    ...
    { title: "Local Reminders", description: "Use the 'Reminders' tab for quick callbacks and review requests. When they're ready, convert them to the funnel with one click.", icon: <IconClock className="w-16 h-16 text-emerald-500" />, color: "bg-emerald-50 dark:bg-emerald-900/20" },
    ...
    { title: "Meet Taxter AI", description: "Your performance coach is always ready. Ask 'How much have I earned this week?' or 'Tell me about the process.'", icon: <IconBot className="w-16 h-16 text-purple-500" />, color: "bg-purple-50 dark:bg-purple-900/20" }
  ];

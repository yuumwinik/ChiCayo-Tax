...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  selfCommissionRate = 300, referralRate = 200, onUpdateMasterCommissions,
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8 no-scrollbar">
        ...
        {activeTab === 'deepdive' && <AdminAnalytics members={members} stats={stats!} appointments={appointments} payCycles={payCycles} users={allUsers} referralRate={referralRate} commissionRate={commissionRate} selfCommissionRate={selfCommissionRate} onManualReferral={onManualReferral} onDeleteReferral={onDeleteReferral} />}
